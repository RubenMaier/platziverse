...
module.export = function setupMetricModel (config) {
  ...
  return sequelize.define('metric', {
    type: {
      ...
      allowNull: false // esto define que el dato es necesario para crear el objeto, o de lo contrario retorna error
    },
    value: {
      type: Sequelize.TEXT, // ponemos text por si queremos pasar estructuras complejas como json, etc...
      allowNull: false
    }
  })
}
